...
### X-Code Archive Publish 
 ...
 6. Bump the version to a major version once the app is ready for primetime, ie: `1.0.0`![Bumping Version](version-bump.png)
 7. In the X-Code toolbar go to Publish -> Archive ![Publish Archive](publish-archive.png)
...
```
 11. After it is done you will see a dialog that looks like this: ![Distribute Dialog](distribute-dialog.png)
 12. Click on the version you just built (the top one in the list) then click "Distribute App"
 13. That takes you to this dialog. To distribute to Test Flight for internal users to test, click on "TestFlight Internal Only"![TestFlight Distribute](testflight-distribute.png)
 14. **To actually publish the app to the app store click on App Store Connect, then Distribute** ![App Store Distribute](appstore-distribute.png)
...
## Google Play Store 
 ...
 4. Important: You will also need to bump the versionCode! ![Version and Version Code](version-versioncode.png)
 5. Now sync the gradle project. 
 6. Now in the Android Studio toolbar, go to Build -> Generate Signed App Bundle or APK... ![Android Build](android-build.png)

 7. Ensure the Android App Bundle option is selected and then click next: ![App Bundle Selection](appbundle.png)
 8. Ensure the next screen appears like in the image. You will need to select the keystore file that you saved on your machine (locally). You will also need the key store password and the key password, which I will send to you: ![Bundle Generation](bundle-gen.png)
 ...
 15. Here you will need to drag or upload the app bundle you generated from Android Studio. ![New Release](new-release.png)
